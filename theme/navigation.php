<?php
    ...
    $logo2 = get_field('alternate_logo', 'option');
 ...
 <style>
    ...
    .transparent .inner .logo-wrap a{
        background-image: url('<?php echo $logo2["url"]?>');
    ...
    .transparent .inner .menu-wrap .menu-item>a{
        color: white;
        transition: 200ms ease;
    }
    .transparent .inner .menu-wrap .menu-item>a:hover{
        text-shadow: 0 0 2px #fff;
    }
    .transparent .inner .header-controls .control-item a svg path{    
        stroke: white;
    }
