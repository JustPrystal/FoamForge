							...
							<?php
								echo apply_filters(
									...
									sprintf(
										...
										esc_html( $_product->add_to_cart_text() == "Add to cart" ? "Add this item to Cart" : $_product->add_to_cart_text())
									),
									$product,
									$args
								);
...
<script>
	...
	$(".products-wrap").slick({
        ...
        prevArrow: `<img class="tab-arrow left-arrow" src="<?php echo $left;?>" alt="">`,
        nextArrow: `<img class="tab-arrow right-arrow" src="<?php echo $right;?>" alt="">`,
		responsive: [
			{
				breakpoint: 992,
				settings: {
